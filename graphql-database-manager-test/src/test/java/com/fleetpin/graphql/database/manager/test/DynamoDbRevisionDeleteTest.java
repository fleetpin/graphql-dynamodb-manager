...
public class DynamoDbRevisionDeleteTest {
	...
	@TestDatabase
	public void testMultipleEnvCheckLinks(final @DatabaseNames({"prod", "stage"}) Database db, @DatabaseNames("prod") final Database dbProd) throws InterruptedException, ExecutionException {
		var entry = new SimpleTable("1", "garry");
